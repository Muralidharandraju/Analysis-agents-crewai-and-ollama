...
def create_data_analysis_crew(knowledge_folder: str, user_input=None):
    ...
    try:
        ...
        print(f"Error creating data analysis crew: {{e}}")
        return "Unable to create data analysis crew, please try again."
